...
public class ServicoMovel
{
	...
	{
		GoogleCredential credencialGoogle = GoogleCredential.fromStream(new FileInputStream(new File("./recursos/alarmsys-4c2f7-firebase-adminsdk-hp4xq-375c23ca94.json"))).createScoped(Arrays.asList(ESCOPO));
